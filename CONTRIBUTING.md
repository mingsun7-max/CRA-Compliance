...
- 翻译、链接或排版问题请在[本仓库议题](https://github.com/mingsun7-max/CRA-Compliance/issues)或拉取请求中提出，并标明语言、文件、检查项编号及原文依据。
- 根目录默认中文，英文采用 `.en.md` 后缀；相应文件须保留双向语言入口。更新正文时同步检查对应语言。
- 1.0 中文清单统一维护于 `1.0/zh-CN/CRA_Checklist_Requirement_v1.0.md`，根目录 `latest` 仅链接该文件。历史稿不得作为当前清单替代品。
